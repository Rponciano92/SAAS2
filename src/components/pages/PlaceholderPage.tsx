      ...
      <div className="glass-card-strong p-6">
        <div className="flex items-center space-x-4">
          <div className="p-3 bg-gradient-to-br from-[#0A74DA] to-[#003B6D] rounded-xl shadow-lg">
            {icon || <Construction size={24} className="text-white" />}
          </div>
          <div>
      ...
      <Card className="glass-card">
        <CardContent className="text-center py-16">
          <div className="flex flex-col items-center gap-4">
            <Construction className="w-16 h-16 text-laranja-cta" />
            <div>
      ...
      {features.length > 0 && (
        <Card className="glass-card">
          <CardContent className="py-8 px-6">
            <h3 className="section-title">Funcionalidades Previstas</h3>
